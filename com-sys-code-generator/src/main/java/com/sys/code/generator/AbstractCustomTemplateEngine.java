...
public abstract class AbstractCustomTemplateEngine {

    protected static final Logger logger = LoggerFactory.getLogger(AbstractTemplateEngine.class);
    /**
     * 配置信息
     */
    private CustomConfigBuilder configBuilder;


    /**
     * 模板引擎初始化
     */
    public AbstractCustomTemplateEngine init(CustomConfigBuilder configBuilder) {
     ...
     * 输出 java xml 文件
     */
    public AbstractCustomTemplateEngine batchOutput() {
        try {
    ...
    public Map<String, Object> getObjectMap(TableInfo tableInfo) {
        ...
        CustomConfigBuilder config = getConfigBuilder();
...
//        objectMap.put("package", config.getPackageInfo());
        objectMap.put("package", this.getPackageInfo(config));
    ...
    public AbstractCustomTemplateEngine setConfigBuilder(CustomConfigBuilder configBuilder) {
        this.configBuilder = configBuilder;
        return this;
    }
    ...
    private Map<String, String> getPackageInfo(CustomConfigBuilder config) {
        ...
        map.put("Mapper", "com.sys.domain." + moduleName);
        map.put("ModuleName", moduleName);
        /*map.put("Xml", System.getProperty("user.dir") + "\\com-sys-domain\\src\\main\\resources\\mapper\\" + moduleName + "\\"
                + config.getTableInfoList().get(0).getEntityName() + "Mapper" + StringPool.DOT_XML);*/
        map.put("ServiceImpl", "com.sys.service." + moduleName + ".impl");
        map.put("Service", "com.sys.service." + moduleName);
        map.put("Controller", "com.sys.controller." + moduleName);
        return map;
    }
}
